...
class Employee(models.Model):
    ...
    currentAddress = models.CharField(
        max_length=100, blank=True, verbose_name='Current Address')
    permanentAddress = models.CharField(
        max_length=100, blank=True, verbose_name='Permanent Address')
    dob = models.DateField(null=True, blank=True)
    joiningDate = models.DateField(
        null=True, blank=True, verbose_name='Joining Date')
    ...
    aadharNumber = models.BigIntegerField(
        default=0, verbose_name='Aadhar Number')
    empCategory = models.CharField(
        max_length=20, blank=True, verbose_name='Employee Category')
